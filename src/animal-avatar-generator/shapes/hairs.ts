...
export const hairs: Shape[] = [
  // curlyHair
  (_, color) => `
    <path fill="${color}" d="M332 100.7c-10.2-27.5-29.9-29.9-53.6-21.5C273.2 72.5 266 67 250 66.3c-15.9.6-23.2 6.2-28.4 13-23.8-8.5-43.4-6.1-53.5 21.4-39 19.8-5.9 84.7 33 64.8 10.9 12 24.4 19.1 48.9 5.7 24.5 13.4 38 6.3 48.9-5.7 38.9 19.9 72-45 33-64.8z"/>
  `,
  // fringeHair
  (_, color) => `
    <path fill="${color}" d="M202.2 99.6c34-8 67.5-7.6 100.4.9 9.3 2.3 14.9 8 13.7 14-7.5 39.7-60.1 79.2-70 71.6-10.8-8.2 2.3-31.4-9.5-33.1-10.4-1.5-25.9 15.9-37.8 11.8-2.7-.9-4.3-2.7-4.2-4.6a161 161 0 00-5.6-46.6c-1.8-6 3.6-11.8 13-14z"/>
  `,
  // palmTreeHair
  (_, color) => `
